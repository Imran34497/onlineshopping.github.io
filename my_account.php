...
<!--my_oder include start-->
<?php 
if(isset($_GET['my_order'])){
include("includes/my_order.php");	
}
?>
<!--my oder include end-->
<!--pay_offline include start-->
<?php 
if(isset($_GET['pay_offline'])){
include("includes/pay_offline.php");	
}
?>
<!--pay_offline include start-->
<!--Edit Account include start-->
<?php 
if(isset($_GET['edit_account'])){
include("includes/edit_account.php");	
}
?>
<!--Edit Account include end-->
<!--change Password include start-->
<?php 
if(isset($_GET['c_password'])){
include("includes/change_password.php");	
}
?>
<!--change Password include end-->
<?php
