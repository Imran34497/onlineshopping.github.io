...
<form action="customer_registration.php" method="POST" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Email" REQUIRED>
  </div>
  <div class="form-group">
    <label >Country</label>
  ...
  <div class="form-group">
   ...
   <div class="form-group">
    ...
    <input type="number" class="form-control" id="exampleInputPassword1" placeholder="Subject" REQUIRED>
  </div>
     <div class="form-group">
    <label >Adress</label>
   ...
   <div class="form-group">
    <label >Image</label>
    <input type="file" class="form-control" id="exampleInputPassword1" placeholder="Subject" REQUIRED>
  </div>
